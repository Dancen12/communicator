...
Q_CONSTINIT const QMetaObject RegisterWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRegisterWindowENDCLASS_t,
        ...
        // method 'back'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_RegisterWindow_rejected'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->registered((*reinterpret_cast< std::add_pointer_t<CurrentUser>>(_a[1]))); break;
        case 1: _t->back(); break;
        case 2: _t->on_RegisterWindow_rejected(); break;
        ...
        {
            using _t = void (RegisterWindow::*)(CurrentUser );
            if (_t _q_method = &RegisterWindow::registered; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &RegisterWindow::back; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void RegisterWindow::registered(CurrentUser _t1)
{

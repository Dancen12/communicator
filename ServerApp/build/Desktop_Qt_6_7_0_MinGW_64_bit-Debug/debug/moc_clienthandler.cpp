...
Q_CONSTINIT static const uint qt_meta_data_CLASSClientHandlerENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       6,    0,   44,    2, 0x09,    8 /* Protected */,

 // signals: parameters
    QMetaType::Void, 0x80000000 | 3,    2,
    QMetaType::Void, QMetaType::Int, QMetaType::Int, 0x80000000 | 5, 0x80000000 | 5,    2,    2,    2,    2,
...
Q_CONSTINIT const QMetaObject ClientHandler::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSClientHandlerENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<ClientHandler *, std::false_type>,
        // method 'sendMessage'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->finished((*reinterpret_cast< std::add_pointer_t<ClientHandler*>>(_a[1]))); break;
        case 1: _t->sendMessage((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<std::string>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<std::string>>(_a[4]))); break;
        ...
        case 0:
            ...
            default: *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType(); break;
            case 0:
                *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType::fromType< ClientHandler* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (ClientHandler::*)(int , int , const std::string & , const std::string & );
...
// SIGNAL 0
void ClientHandler::finished(ClientHandler * _t1)
{
...
// SIGNAL 1
void ClientHandler::sendMessage(int _t1, int _t2, const std::string & _t3, const std::string & _t4)
{
